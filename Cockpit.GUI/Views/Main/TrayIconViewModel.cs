...
namespace Cockpit.GUI.Views.Main
{
    public class TrayIconViewModel : PropertyChangedBase,
        ...
        Core.Common.Events.IHandle<ProfileStateChangedEvent>,
    ...
    IDisposable
    {
        ...
        private ProfileStateChangedEvent lastScriptEvent;
        ...
        public void ShowWindow()
        {
            ...
            if (Process.GetCurrentProcess().ProcessName == "Cockpit" && !Process.GetCurrentProcess().MainWindowTitle.StartsWith("Cockpit"))
                Process.GetCurrentProcess().Close();
            var p = Process.GetProcessesByName("Cockpit");
            p = Process.GetProcesses();
            var Cockpit = "Cockpit - Programmable";
            foreach (var proc in p)
            {
                if (proc.MainWindowTitle.StartsWith(Cockpit))
        ...
        public ProfileStateChangedEvent LastScriptEvent
        {
